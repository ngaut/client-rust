...
| `txnkv/txnsnapshot` | `src/transaction/snapshot.rs`, transaction reads | unassessed | Include scans, read options, replica behavior, cache, and runtime stats decisions. |
